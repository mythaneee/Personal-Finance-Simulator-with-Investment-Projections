...
## Features
- Add transactions of various types.
- Transactions are classified accordingly.
- Generates a summarized version of all transactions.
- Calculates net value for user.
- Projects investments for 1, 3 or 5 years compounded anually.
- Re-prompts users if there are invalid inputs.